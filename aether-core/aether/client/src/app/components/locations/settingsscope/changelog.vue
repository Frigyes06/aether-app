...
- **New graph compiler.** You can find more information about this [here on the blog](https://blog.getaether.net/post/185689269152/aether-dev13-released-much-faster-updates). But in short, this reduces the speed of frontend refreshes up to 30x. However, since this is a large change, we want to thoroughly test this. If you see anything weird with things not updating where they should, please let us know in the [meta forum](https://meta.getaether.net)
