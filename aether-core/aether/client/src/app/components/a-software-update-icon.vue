<template>
  <div
    class="software-update-icon"
    hasTooltip
    title="New update ready<br> Click here to restart the app"
    @click="triggerUpdate"
  >
    <a-header-icon
      class="notifications-icon"
      icon="regular/arrow-alt-circle-up"
      iconunder="circle"
    ></a-header-icon>
  </div>
</template>
    ...
    svg.fa-icon {
      ...
      svg.icon-background-color {
        ...
        @keyframes UPDATE_NOTIFY {
          0% {
            fill: #bd4c52; // $a-red * 0.8;
          }
          25% {
            fill: #4c8f8f; // $a-turquoise * 0.8;
          }
          50% {
            fill: #527aa3; // $a-cerulean * 0.8;
          }
          75% {
            fill: #9e769e; // $a-purple * 0.8;
          }
          100% {
            fill: #bd4c52; // $a-red * 0.8;
          }
