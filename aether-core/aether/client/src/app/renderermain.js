    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            browserWindowProvider.initialize({
        ...
        case 1:
          ...
          return [
            4 /*yield*/,
            browserWindowProvider.loadDictionary(
              'en',
              new Uint8Array(dic),
              new Uint8Array(aff)
            ),
        ...
        case 2:
          ...
          return [
            4 /*yield*/,
            ElectronHunspell.attachSpellCheckProvider(browserWindowProvider),
          ]
        case 3:
          attached = _a.sent()
