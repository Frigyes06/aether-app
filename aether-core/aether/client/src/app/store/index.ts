...
let actions = {
  ...
  */
  ...
  setNewView(context: any, newView: any) {
...
let mutations = {
  ...
  */
  ...
  SET_NEW_VIEW(state: any, newView: any) {
  ...
  =            Mod actions            =
  ===================================*/
  SET_CURRENT_BOARD_MODACTIONS(state: any, boardModActions: any) {
    state.currentBoardsModActions = boardModActions
    state.currentBoardsModActionsArrived = true
  },
  SET_CURRENT_BOARD_MODACTIONS_ARRIVED(state: any, arrived: boolean) {
