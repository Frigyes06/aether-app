...
var actions = __assign(__assign(__assign(__assign(__assign({ 
    /*----------  Refreshers  ----------*/
    /*
...
var mutations = __assign(__assign(__assign({ SET_SIDEBAR_STATE: function (state, sidebarOpen) {
    ...
    */
    ...
    SET_HOME_VIEW: function (state, threads) {
        ...
        // If there's a change, apply the new whitelist.
        if (state.sfwListDisabled != sfwListDisabled ||
