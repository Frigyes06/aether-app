            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, window.electronAPI.GetFrontendAPIPort()];
                    case 3:
                        feapiport = _a.sent();
                        ...
                        return [4 /*yield*/, window.electronAPI.GetClientAPIServerPort()];
                    case 4:
...
function WaitUntilFrontendReady(cb) {
    function check() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, window.electronAPI.GetFrontendClientConnInitialised()
